...
import { DrugJsonService } from './service/drugJson.service';
...
export class AppComponent {
  ...
  constructor(private drugJsonService: DrugJsonService) {
  }

  ngOnInit(){
    this.drugJson1Data = this.drugJsonService.data1;
    this.drugJson2Data = this.drugJsonService.data2;
  }
